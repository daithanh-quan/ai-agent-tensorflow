...
const KnifeForkIcon: React.FC<Props> = ({ className }) => {
  return (
    <svg
      width="53"
      height="45"
    ...
    >
      <g clipPath="url(#clip0_63236_61)">
        <g clipPath="url(#clip1_63236_61)">
          <path
      ...
      <defs>
        <clipPath id="clip0_63236_61">
          <rect width="53.0001" height="45" fill="white" />
        </clipPath>
        <clipPath id="clip1_63236_61">
          <rect width="53.0001" height="45" fill="white" />
        </clipPath>
      </defs>
    </svg>
